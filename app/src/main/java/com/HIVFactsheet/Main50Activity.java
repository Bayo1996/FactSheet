...
public class Main50Activity extends AppCompatActivity implements View.OnClickListener {
    WebView mWebView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("file:///android_asset/refers/linnk.php");
