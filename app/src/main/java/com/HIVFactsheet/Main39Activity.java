...
public class Main39Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isNetworkAvailable()) {
            myWebView.loadUrl("https://www.youtube.com/channel/UCtU3EAv0jqgoEc65ZQxGutQ/videos?view_as=subscriber");
        }
    ...
    public class MyWebChromeClient extends WebChromeClient {
        ...
        public void onShowCustomView(View view, CustomViewCallback callback) {
            ...
            mCustomViewContainer = new FrameLayout(Main39Activity.this);
