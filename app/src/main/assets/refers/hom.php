...
<footer>
     <div class="col-md-12" >
      ...
      <li ><a  class="fa fa-twitter" style="background:#b4b4b4; color: lightblue;" href="http://www.twitter.com/HIVFactSheet" target="_blank"></a></li>
      </ul>
      <br>
     </div>
     </div>
  href="http:///www.twitter.com/HIVFactSheet"
